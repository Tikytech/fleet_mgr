      ...
      <table class="w-full text-sm">
        ...
        <template v-for="data in tableData" :key="data?.id">
          <tr class="border-b">
            ...
            <td class="text-left px-4 py-4">{{ data?.contact_person }}</td>
            <td class="text-left px-4 py-4 capitalize">{{ data?.contact_phone }}</td>
            <td class="text-left px-4 py-4">{{ data?.address }}</td>
