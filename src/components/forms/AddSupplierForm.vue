  ...
  <div class="">
    ...
    <form @submit.prevent="submitForm" class="p-4 space-y-4">
      ...
      <div class="">
        ...
        <input required class="input mt-1" type="text" id="name" placeholder="Enter Supplier Name"
      ...
      <div class="">
        ...
        <input required class="input mt-1" type="text" id="contact_person" placeholder="Enter Contact Person's Name"
      ...
      <div class="">
        ...
        <input required class="input mt-1" type="text" id="contact_phone"
          placeholder="Enter Contact Person's Phone Number" v-model="supplierData.contact_phone" />
      </div>

      <!-- address -->
      <div class="">
        <label for="address">Address</label>
        <input required class="input mt-1" type="text" id="address" placeholder="Enter Address"
